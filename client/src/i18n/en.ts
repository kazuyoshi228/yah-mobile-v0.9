const en = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Can I delete and reinstall my eSIM?", a: "Please do not delete the eSIM from your device after installing it. If you accidentally deleted it or are switching phones, contact our support first — we'll check whether your eSIM can be restored." },
